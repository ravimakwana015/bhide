<table class="table" style="width:100%" id="card-table">
    <thead>
    <tr>
        <th>Brand</th>
        <th>Number</th>
                    ...
                    @if(isset($defaultPaymentMethod) && $defaultPaymentMethod!='' && $defaultPaymentMethod!=$card->id)
                        <div class="set-default-wrap" >
                            ...
                            <div class="set-default" id="default_{{ $key }}">
                                <a href="javascript:;" onclick="setDefaultCard('{{ $card->id }}','{{ route('set-default-card') }}','{{ route('subscription') }}')">Set as default</a>
                            </div>
                        </div>
                    @endif
                </td>
