...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('member_type') ? ' is-invalid' : '' }}">
            {{ Form::label('member_type', 'Resident Type', ['class' =>'control-label required']) }}
            {{ Form::select('member_type', [""=>"Select Resident Type","Owner - Living at property"=>"Owner - Living at property","Owner - Living away from Property"=>"Owner - Living away from Property","tenant"=>"Tenant"],null, ['class' => 'form-control','id'=>'member_type']) }}
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group {{ $errors->has('password') ? ' is-invalid' : '' }}">
            ...
            {{ Form::password('password', null, ['class' => 'form-control '.($errors->has('password') ? 'is-invalid':''), 'placeholder' => 'Password']) }}
