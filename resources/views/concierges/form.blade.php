<div class="row">
    <div class="col-md-3">
        <div class="form-group {{ $errors->has('gate_id') ? ' is-invalid' : '' }}">
            {{ Form::label('gate_id','Core', ['class' => 'control-label required']) }}
            <br />
            @if(isset($concierge))
            <div id="new_gate">
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group {{ $errors->has('phone_number') ? ' is-invalid' : '' }}">
            {{ Form::label('phone_number','Contact Number', ['class' => 'control-label required']) }}
            {{ Form::text('phone_number', null, ['class' => 'form-control '.($errors->has('phone_number') ? 'is-invalid':''), 'placeholder' => 'Contact Number']) }}
    ...
    {{-- <div class="col-md-3">
        <div class="form-group {{ $errors->has('shift_start') ? ' is-invalid' : '' }}">
            {{ Form::label('shift_start','Shift Start Time', ['class' => 'control-label required']) }}
            <br />
            {{ Form::text('shift_start', null, ['class' => 'form-control shift_start'.($errors->has('shift_start') ? 'is-invalid':''), 'placeholder' => 'Shift Start Time' ,'readonly']) }}
    ...
    <div class="col-md-3">
        <div class="form-group {{ $errors->has('shift_end') ? ' is-invalid' : '' }}">
            {{ Form::label('shift_end','Shift End Time', ['class' => 'control-label required']) }}
            <br />
            {{ Form::text('shift_end', null, ['class' => 'form-control shift_end'.($errors->has('shift_end') ? 'is-invalid':''), 'placeholder' => 'Shift End Time' ,'readonly']) }}
    ...
    <div class="col-md-4">
        <div class="form-group">
            {{ Form::label('concierge_image', 'Profile Picture', ['class' => 'control-label required']) }}
...
<hr />
<h5>Concierge Address</h5>
<hr />
<div class="row">
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('address') ? ' is-invalid' : '' }}">
            {{ Form::label('address','First Line', ['class' => 'control-label required']) }}
            {{ Form::text('address', null, ['class' => 'form-control '.($errors->has('address') ? 'is-invalid':''), 'placeholder' => 'First Line']) }}
    ...
    <div class="col-md-4">
        <div class="form-group {{ $errors->has('state') ? ' is-invalid' : '' }}">
            {{ Form::label('state','Second Line', ['class' => 'control-label required']) }}
            {{ Form::text('state', null, ['class' => 'form-control '.($errors->has('state') ? 'is-invalid':''), 'placeholder' => 'Second Line']) }}
            @if ($errors->has('state'))
