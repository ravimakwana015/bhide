...
<div class="main dashboard-page">
    ...
    <section class="appointment-info till-grids">
        <div class="row">
            <div class="col-10">
                <h2>
                    {{ \App\Models\Company::where(['user_id' => Auth::user()->id])->pluck('company_name')->first() }} - Dashboard <span id="clockbox_old"></span>
                </h2>
            </div>
        ...
        <div class="top-grids grids">
            ...
            <div class="grid top-grid">
                <a href="{{ route('issues.index') }}">
                    <h3>{{ $master['issue'] }}</h3>
                    <span>Today's Issue Requests</span>
                </a>
            </div>
        </div>
        <div class="three-col-grids two-col-grids">
            ...
            <div class="three-col-grid">
                ...
                <div class="Notification-listing">
                    <ul>
                        ...
                        <li>
                            <div class="checked done"><i class="fas fa-check-circle"></i></div>
...
<script type="text/javascript">
    ...
    function GetClock(){
        ...
        document.getElementById('clockbox_old').innerHTML=clocktext;
    }
