                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h3 class="card-title">Loyalty Store</h3>
                                </div>
                                <div class="col-sm-6">
                                    <a href="javascript:;" class="btn btn-primary float-right elevation-4" id="addButton"><i class="fas fa-plus"></i> Add Loyalty Store</a>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLongTitle">Add Loyalty Store</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {{ Form::open(['route' => 'loyaltystores.store','role' => 'form', 'method' => 'post', 'id' => 'create-service']) }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="{{ $errors->has('category_id') ? ' is-invalid' : '' }}">
                            {{ Form::label('category_id','Store Category', ['class' => 'control-label required']) }}
...
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="deleteModalLongTitle">Edit Loyalty Store</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="deleteModalLongTitle">Are you Sure You want Delete Loyalty Store ??</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <form action="{{ route('admin.loyaltystores.delete') }}" method="post" role="form" id="editForm" enctype="multipart/form-data">
            {{csrf_field()}}
    ...
    $(document).ready(function () {
        $('#create-service').validate({
            ...
            submitHandler: function (form) {
                addService('{{ route('loyaltystores.store') }}','create-service','services','addService');
                //return false;
                setTimeout(function(){ 
...
<script type="text/javascript">
    ...
    submitHandler: function(form) {
        ...
        $.ajax({
            ...
            url: "{{route('admin.loyaltystores.update')}}",
            type: "POST",
            ...
            success: function (data) {
                $('#loading').hide();
                if(data.status==1){
                    $( '.register-form-errors' ).html('<div class="alert alert-success">Loyalty Store Update Successfully</div>');
                    setTimeout(function(){ 
                        $("#editModal").modal('hide');
                        window.location.reload();
                    }, 5000);
