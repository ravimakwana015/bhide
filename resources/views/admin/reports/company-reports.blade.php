                            ...
                            <div class="box-header" style="padding-top: 10px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {!! Form::select('subscription_times', $company_name, null, ["class" => "form-control filter-select2","placeholder" => "Select Company"]) !!}
                                    ...
                                    <div class="col-md-3">
                                        {!! Form::select('subscription_time', ['month'=>'Monthly','quarter'=>'Quarter','year'=>'Year'], null, ["class" => "form-control filter-select2","placeholder" => "Subscription Time"]) !!}
                                    </div>
                                </div>
                            </div>
                            <hr/>
