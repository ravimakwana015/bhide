<div class="modal fade bd-example-modal-lg" id="editService" tabindex="-1" role="dialog"
    aria-labelledby="editServiceTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLongTitle">Edit Notice</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {!! Form::model($messageBoard, ['route' => ['messageBoard.update', $messageBoard->id], 'role' => 'form', 'method' =>
        'PATCH','id'=>'messageBoard-edit','files' => true]) !!}
