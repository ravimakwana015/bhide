<div class="modal fade bd-example-modal-lg" id="addStore" tabindex="-1" role="dialog"
    aria-labelledby="addStoreTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLongTitle">Add Loyalty Card Store</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {{ Form::open(['route' => 'loyaltyCard.store','role' => 'form', 'method' => 'post', 'id' => 'create-store','files' => true]) }}
